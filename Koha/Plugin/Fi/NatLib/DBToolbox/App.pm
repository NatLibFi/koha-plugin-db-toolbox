package Koha::Plugin::Fi::NatLib::DBToolbox::App;
...
use base qw(
    Koha::Plugin::Fi::NatLib::DBToolbox::App::Initiate
    Koha::Plugin::Fi::NatLib::DBToolbox::App::Crontab
    Koha::Plugin::Fi::NatLib::DBToolbox::App::Defaults
);
